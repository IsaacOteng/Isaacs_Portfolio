    ...
    const About = () => {
        ...
        return (
            ...
            <div className="text-center mb-12 flex flex-col items-center">
                <p className="text-3xl md:text-4xl text-green-700 dark:text-green-400 font-bold mb-4">
                    About Me
                </p>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl
                              font-serif text-center max-w-4xl leading-relaxed text-gray-700 dark:text-gray-400">
