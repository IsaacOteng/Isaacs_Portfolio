...
const Intro = () => {
    return (
        <section
            id="home"
            className="relative w-ull mb-28 flex justify-center pt-10 mx-0 sm:mx-0 md:mx-3 lg:mx-0 xl:mx-0
                        sm:pt-16 md:pt-20 lg:pt-15"
        >
            <div
                className="relative w-full mx-4 sm:mx-8 md:mx-12 lg:mx-10
                            bg-linear-to-br from-white via-green-50 to-green-200
                            dark:from-gray-900 dark:via-green-950/30 dark:to-green-950
                            shadow-2xl rounded-3xl flex flex-col md:flex-row overflow-visible
            ...
            >
                <AnimatedOnScroll className="flex-1 p-6 sm:p-10 md:p-16 lg:p-20 mb-10 md:mb-0 sm:mb-0" delay={0.05}>
                    ...
                    <div className="flex flex-wrap gap-4 mb-0 sm:mb-10">
                        <a href="https://wa.me/233545573689" target="_blank" rel="noreferrer">
                            <button className="px-4 py-2 md:px-6 md:py-2 bg-green-700 dark:bg-green-600 text-white rounded-xl hover:bg-green-800 dark:hover:bg-green-700 hover:shadow-lg hover:shadow-green-700/30 font-semibold flex items-center gap-2 hover:-translate-y-0.5">
                                Hire Me!
                                <ArrowRight size={20}/>
                            </button>
                        </a>
                        <button className="px-3 py-2 md:px-4 md:py-2 flex items-center gap-2 text-green-700 dark:text-green-400 bg-green-200/60 dark:bg-green-900/30 rounded-full border border-green-300 dark:border-green-700 hover:bg-green-200 dark:hover:bg-green-800/40 font-semibold">
                        ...
                        <a
                            ...
                            className="px-6 py-3 md:px-8 md:py-4 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 rounded-xl hover:bg-gray-800 dark:hover:bg-white hover:-translate-y-0.5 font-semibold"
                        >
                            Download CV
                        </a>
                    </div>
                ...
                <AnimatedOnScroll
                    className="relative flex-1 flex items-center justify-center
                                p-6 md:p-0 -mt-23 sm:-mt-16 md:mt-16 lg:mt-22 xl:mt-0 mb-5"
                    delay={0.15}
                >
                    <img
                        src={pic}
